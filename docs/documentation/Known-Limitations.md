...
- **Battle system is not yet implemented**: pet battle stats (strength, speed, defense) are tracked and increase with leveling but are not currently used in any gameplay system.
...
- **Mobile layout not optimized**: the app is designed for desktop use and has not been tested or optimized for mobile screens.
